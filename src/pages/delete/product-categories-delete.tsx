    ...
    <UserTemplate templateParams={templateParams}>
      <div className="flex h-full w-full items-center justify-center">
        <div className="flex h-fit w-1/3 flex-col rounded-xl bg-[#C4B0FF45] py-8">
          <p className="h-1/4 w-full items-center border-b-2 border-[#11009E] pb-8 pl-4 pt-2 text-lg font-semibold">
          ...
          <div className="flex h-1/4 w-full justify-between self-end px-4 pt-8">
