...
const BrandAndPackagingTypeDelete: React.FunctionComponent = () => {
  ...
  return (
    <UserTemplate templateParams={templateParams}>
      ...
      <div className="flex h-[60vh] w-full flex-col p-4">
        ...
        <div className="flex h-fit w-full items-center justify-evenly rounded-b-[10px]  bg-[#C4B0FF45] p-2  ">
...
export default BrandAndPackagingTypeDelete;
